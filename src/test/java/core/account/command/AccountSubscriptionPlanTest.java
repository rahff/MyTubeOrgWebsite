...
import fr.myTube.website.core.account.command.AccountSubscription;
import fr.myTube.website.core.account.ports.driven.SubscriptionGateway;
...
public class AccountSubscriptionPlanTest extends BaseAccountCommandTest {
  ...
  void A_customer_choose_a_subscription_plan() {
    ...
    verify(accountGateway).saveAccount(eq(AccountProvider.getValidatedAccountWithUnPaidSubscription()));
  }
}
